...
| **Tested** | **Result** | **Validation Result** |
| ----------- | ----------- | ----------- |
| settings | One URL was too long, while the other lines that exceeded the recommended length were automatically generated by Django. |<details><summary>Result</summary>![Result](/docs/validation/pep8/settings.png)</details>|
...
|users/viiews | All clear, no errors found |<details><summary>Result</summary>![Result](/docs/validation/pep8/users-viewss.png)</details>|
|||
