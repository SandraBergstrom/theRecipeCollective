...
--- | --- | --- | :---:
|As a first-time user, I want to learn more about the recipe collective, feel a good first impression and a welcoming attitude.|Press the About button in the navigation bar that is visible in the landing page| Pressing the bottom takes me to the About page|:white_check_mark:
